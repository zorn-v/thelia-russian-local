...
return [
    ...
    'localpickup.bo.default' => [
        'Configure local pickup price' => 'Настроить цену самовывоза',
        'Save changes' => 'Сохранить изменения',
    ],
    'localpickup.fo.default' => [
        'Available' => 'Доступно',
        'Back' => 'Назад',
        'Billing address' => 'Адрес оплаты',
        'Cart' => 'Корзина',
        'Change address' => 'Сменить адрес',
        'Choose your payment method' => 'Выберите метод оплаты',
        'Code :' => 'Код :',
        'Coupon code' => 'Код купона',
        'Delivery address' => 'Адрес доставки',
        'Discount' => 'Скидка',
        ...
        'Total' => 'Всего',
        'Unit Price' => 'Цена ед.',
        'You may have a coupon ?' => 'У вас есть купон ?',
    ...
    'theliamigratecountry.bo.default' => [
        ' country ' => 'страну',
    ...
    'virtualproductcontrol.bo.default' => [
